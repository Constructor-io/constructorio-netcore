\label{index_md_constructor_constructorio_netcore_README}%
\Hypertarget{index_md_constructor_constructorio_netcore_README}%
 \href{http://constructor.io/}{\texttt{ Constructor.\+io}} provides search as a service that optimizes results using artificial intelligence (including natural language processing, re-\/ranking to optimize for conversions, and user personalization).

Full API documentation is available on \href{https://constructor-io.github.io/constructorio-netcore/}{\texttt{ Github Pages}}\hypertarget{index_autotoc_md1}{}\doxysection{Installation}\label{index_autotoc_md1}

\begin{DoxyEnumerate}
\item Follow the directions at \href{https://www.nuget.org/packages/constructor.io/}{\texttt{ nuget}} to add the client to your project.
\item Retrieve your autocomplete token and key. You can find this at your \href{https://constructor.io/dashboard}{\texttt{ Constructor.\+io dashboard}}.
\item Create a new instance of the client. 
\begin{DoxyCode}{0}
...
\end{DoxyEnumerate}\hypertarget{index_autotoc_md2}{}\doxysection{Uploading a Catalog}\label{index_autotoc_md2}
...
\DoxyCodeLine{CatalogResponse response = await constructorio.Catalog.ReplaceCatalog(request);}

\end{DoxyCode}
\hypertarget{index_autotoc_md3}{}\doxysection{Retrieving Autocomplete Results}\label{index_autotoc_md3}
...
\DoxyCodeLine{AutocompleteResponse response = await constructorio.Autocomplete.GetAutocompleteResults(request);}

\end{DoxyCode}
\hypertarget{index_autotoc_md4}{}\doxysection{Retrieving Search Results}\label{index_autotoc_md4}
...
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{comment}{// Request results as an object}}
\DoxyCodeLine{SearchResponse response = await constructorio.Search.GetSearchResults(request);}

\end{DoxyCode}
\hypertarget{index_autotoc_md5}{}\doxysection{Retrieving Browse Results}\label{index_autotoc_md5}
...
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{comment}{// Request results as an object}}
\DoxyCodeLine{BrowseResponse response = await constructorio.Browse.GetBrowseResults(request);}

\end{DoxyCode}
\hypertarget{index_autotoc_md6}{}\doxysection{Retrieving Browse Results for Item ID\textquotesingle{}s}\label{index_autotoc_md6}
...
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{comment}{// Request results as an object}}
\DoxyCodeLine{BrowseResponse response = await constructorio.Browse.GetBrowseItemsResults(request);}

\end{DoxyCode}
\hypertarget{index_autotoc_md7}{}\doxysection{Retrieving Recommendation Results}\label{index_autotoc_md7}
...
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{comment}{// Request results as an object}}
\DoxyCodeLine{RecommendationsResponse response = await constructorio.Recommendations.GetRecommendationsResults(request);}

\end{DoxyCode}
\hypertarget{index_autotoc_md8}{}\doxysection{Retrieving All Tasks}\label{index_autotoc_md8}
...
\DoxyCodeLine{AllTasksResponse response = await constructorio.Tasks.GetAllTasks(request);}

\end{DoxyCode}
\hypertarget{index_autotoc_md9}{}\doxysection{Retrieving Task with task\+\_\+id}\label{index_autotoc_md9}
...
\DoxyCodeLine{Task response = await constructorio.Tasks.GetTask(request);}

\end{DoxyCode}
\hypertarget{index_autotoc_md10}{}\doxysection{Development}\label{index_autotoc_md10}
\hypertarget{index_autotoc_md11}{}\doxysubsection{Using VS Code}\label{index_autotoc_md11}
...
\end{DoxyItemize}\hypertarget{index_autotoc_md12}{}\doxysubsection{For code coverage\+:}\label{index_autotoc_md12}
...
\end{DoxyItemize}\hypertarget{index_autotoc_md13}{}\doxysubsection{Documentation}\label{index_autotoc_md13}
