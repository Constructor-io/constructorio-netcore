...
internal sealed class NewtonsoftJsonUtf8Content : HttpContent
{
    ...
    protected override Task SerializeToStreamAsync(Stream stream, TransportContext context)
    {
        ...
        using StreamWriter streamWriter = new(stream, encoding: Encoding.UTF8, leaveOpen: true, bufferSize: systemTextJsonJsonSerializerOptionsDefaultBufferSize /* needs bufferSize to have leaveOpen... */);
        DefaultJsonSerializer.Serialize(streamWriter, _body);
